    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('like_user_set', models.ManyToManyField(blank=True, related_name='like_user_set', through='appname.Like', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.AddField(
            model_name='like',
            name='post',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='appname.Post'),
        ),
        migrations.AddField(
            model_name='like',
            name='user',
